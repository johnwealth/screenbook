 ...
 <div class="theme-layout">
    <header>
      <div class="container">
        <div class="logo"><a href="{{route('welcome')}}" title=""><img src="images/logo.PNG" alt="" /></a></div><!-- Logo -->
    ...
    <div class="menubar">
      <nav>
       <ul>
        ...
        <li><a href="{{route('tutorial')}}" title="">Tutorial Videos</a>
        <!--   <ul>
            <li><a href="#" title="">Jamb Test</a></li>
          <li><a href="#" title="">Waec</a></li>
         </ul> -->
        </li>
        <li><a href="{{route('blog')}}" title="">Blog</a>
        </li>
